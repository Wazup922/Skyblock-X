...
public class Skyblock extends JavaPlugin {
    ...
    public HashMap<UUID, Location[]> adminSelection = new HashMap<>();
    ...
    public int createIsland(String name, String displayedOwner, String themeName){
        ...
        islandsFile.set("Islands." + selectedID + ".Warps.Spawn", Utils.getStringFromLocation(theme.getSpawn(center), false));
